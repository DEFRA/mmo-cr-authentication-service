...
- **The planner performs this single research pass** to validate those steps before returning the plan: the
  **Auth Planner** for Complex work, or the **Auth Developer** when it produces the lightweight inline plan
...
**revise** / **blocked**) so the plan can be finalised against it. When the **Auth Planner** produced the

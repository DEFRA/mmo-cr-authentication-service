# MMO Catch Recording — Authentication Service (Project Guidelines)

This repository holds the source code for the **MMO Catch Recording Authentication Service**, a backend
...
(including [Auth Developer](.github/agents/auth-developer.agent.md),
[Auth Planner](.github/agents/auth-planner.agent.md),
[Auth Orchestrator](.github/agents/auth-orchestrator.agent.md) and
[Auth Code Reviewer](.github/agents/auth-code-reviewer.agent.md)).
...
4. **Plan** — For **Complex** work, delegate planning to the designated planning agent (for backend
   implementation, [Auth Planner](.github/agents/auth-planner.agent.md)), which returns a complete

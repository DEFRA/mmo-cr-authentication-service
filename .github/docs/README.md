...
├── agents/
│   ├── auth-orchestrator.agent.md
│   ├── auth-planner.agent.md
│   ├── auth-developer.agent.md
│   └── auth-code-reviewer.agent.md
├── instructions/
...
Agent names are **service-scoped** (`Auth Orchestrator`, `Auth Planner`, `Auth Developer`,
`Auth Code Reviewer`) so they stay unique when several Catch Recording repositories are open in the same
...
| Property       | Value                                                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------------------------------------- |
| File           | `agents/auth-orchestrator.agent.md`                                                                                       |
...
| Property       | Value                                                                           |
| -------------- | ------------------------------------------------------------------------------- |
| File           | `agents/auth-planner.agent.md`                                                  |
...
| Property       | Value                                                                                                                   |
| -------------- | ----------------------------------------------------------------------------------------------------------------------- |
| File           | `agents/auth-developer.agent.md`                                                                                        |
...
| Property       | Value                                                                                                 |
| -------------- | ----------------------------------------------------------------------------------------------------- |
| File           | `agents/auth-code-reviewer.agent.md`                                                                  |
...
Select `Auth Orchestrator` in VS Code agent mode.
...
Select `Auth Developer` in VS Code agent mode.
...
Is the change trivial?
  (typo, doc, single config value, obvious small fix, missing test for known behaviour)
        │
       Yes ──► Auth Developer directly — Read → Implement → Test → Summarise
        │
        No
        │
...
or the published API contract?
        │
       Yes ──► Auth Orchestrator — Plan → Approval → Implement → (optional) Review
        │
        No  ──► Auth Developer directly (Standard: lightweight inline plan → approval → implement).
